      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center border-b border-gray-800 pb-4 mb-4">
          ...
          <div className="flex space-x-5">
            <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">
            ...
            <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Main Footer Links - Simplified and Compact */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="col-span-2 md:col-span-1">
            <p className="text-xs text-gray-400 mb-4">Your AI-powered platform for campus placement preparation.</p>
            <a href="#" className="inline-block px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-xs font-medium rounded-full hover:opacity-90 transition-opacity">
              Get Started
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="text-xs space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Interviews</a></li>
        ...
        <div className="mt-8 pt-4 border-t border-gray-800 flex justify-center">
          <p className="text-xs text-gray-500">© 2025 Placement-Prep</p>
        </div>
      </div>
    </footer>
  );
